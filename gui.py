...
def header():
    ...
    row1.markdown('''
        <p align="center">
        <img src="https://raw.githubusercontent.com/ismiyayukr/FPA-VRPTW/main/VRP-Image.png" width="390" height="300">
        </p>
...
def tampilkan_data():
    ...
    data_vrptw = from_data.ekstrak_data(
        path = 'https://raw.githubusercontent.com/ismiyayukr/FPA-VRPTW/main/Data VRP-TW.xlsx', 
